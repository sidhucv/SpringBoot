...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        log.debug("inside the bootstrap class");
        ...
        log.debug("after unit of measure");
        //get Categories
        ...
        guacNotes.setReciepeNotes("For a very quick guacamole just take a 1/4 cup of salsa and mix it in with your mashed avocados.\n" +
        ...
        tacoNotes.setReciepeNotes("We have a family motto and it is this: Everything goes better in a tortilla.\n" +
